...
const GEMINI_API_KEY = 'AIzaSyDsQwLwVCDf6XjhFb7Qa5qHmNE_LifWbC4'; 
...
const Chatbot: React.FC = () => {
  ...
  return (
    ...
    <div className="max-w-md h-max-[5vh] mx-auto p-0 bg-white/80 rounded-2xl shadow-2xl border border-blue-100 backdrop-blur-md" style={{ background: 'linear-gradient(135deg, #f0f4ff 0%, #e0e7ff 100%)' }}>
