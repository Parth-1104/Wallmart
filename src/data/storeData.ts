...
export const foodItems: (FoodItem & { deal?: string })[] = [
  // Produce
  { id: '1', name: 'Apples', category: 'Fruit', location: { section: 'produce', aisle: 1, shelf: 'A', coordinates: { x: 2, y: 2 } }, deal: '20% Off' },
  ...
  // Dairy
  { id: '5', name: 'Milk', category: 'Dairy', location: { section: 'dairy', aisle: 3, shelf: 'A', coordinates: { x: 7, y: 1 } }, deal: 'Buy 1 Get 1' },
  { id: '6', name: 'Eggs', category: 'Dairy', location: { section: 'dairy', aisle: 3, shelf: 'B', coordinates: { x: 8, y: 2 } } },
  
  // Meat & Seafood
  { id: '7', name: 'Chicken Breast', category: 'Meat', location: { section: 'meat', aisle: 4, shelf: 'A', coordinates: { x: 11, y: 1 } }, deal: '15% Off' },
  { id: '8', name: 'Salmon', category: 'Seafood', location: { section: 'meat', aisle: 4, shelf: 'B', coordinates: { x: 12, y: 2 } } },
  
  // Bakery
  { id: '9', name: 'Bread', category: 'Bakery', location: { section: 'bakery', aisle: 5, shelf: 'A', coordinates: { x: 15, y: 1 } }, deal: '2 for $5' },
  ...
  // Snacks
  { id: '14', name: 'Chips', category: 'Snacks', location: { section: 'snacks', aisle: 9, shelf: 'A', coordinates: { x: 2, y: 5 } }, deal: '10% Off' },
  
  // Beverages
  { id: '15', name: 'Orange Juice', category: 'Beverages', location: { section: 'beverages', aisle: 10, shelf: 'A', coordinates: { x: 8, y: 7 } }, deal: 'Buy 2 Get 1 Free' },
  
  // Health & Beauty
  { id: '16', name: 'Shampoo', category: 'Health', location: { section: 'health', aisle: 11, shelf: 'A', coordinates: { x: 14, y: 7 } }, deal: 'Save $1' },
  ...
  { id: '20', name: 'TV', category: 'Electronics', location: { section: 'electronics', aisle: 14, shelf: 'A', coordinates: { x: 19, y: 7 } }, deal: '10% Off' },
  ...
  { id: '24', name: 'Action Figure', category: 'Toys', location: { section: 'toys', aisle: 16, shelf: 'A', coordinates: { x: 7, y: 15 } }, deal: 'BOGO 50% Off' },
  { id: '25', name: 'Board Game', category: 'Toys', location: { section: 'toys', aisle: 16, shelf: 'B', coordinates: { x: 9, y: 16 } } },
  { id: '26', name: 'Notebook', category: 'Stationery', location: { section: 'stationery', aisle: 17, shelf: 'A', coordinates: { x: 13, y: 15 } }, deal: '15% Off' },
