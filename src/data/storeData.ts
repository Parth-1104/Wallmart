...
export const storeSections: StoreSection[] = [
  ...
  { id: 'clothing', name: 'Clothing', color: '#A21CAF', coordinates: { x: 1, y: 8, width: 4, height: 1 } },
  { id: 'toys', name: 'Toys', color: '#F59E42', coordinates: { x: 6, y: 10, width: 4, height: 2 } },
  { id: 'stationery', name: 'Stationery', color: '#6366F1', coordinates: { x: 12, y: 10, width: 4, height: 2 } },
];
...
export const foodItems: FoodItem[] = [
  ...
  { id: '22', name: 'T-shirt', category: 'Clothing', location: { section: 'clothing', aisle: 15, shelf: 'A', coordinates: { x: 2, y: 8 } } },
  { id: '23', name: 'Jeans', category: 'Clothing', location: { section: 'clothing', aisle: 15, shelf: 'B', coordinates: { x: 4, y: 8 } } },
  { id: '24', name: 'Action Figure', category: 'Toys', location: { section: 'toys', aisle: 16, shelf: 'A', coordinates: { x: 7, y: 10 } } },
  { id: '25', name: 'Board Game', category: 'Toys', location: { section: 'toys', aisle: 16, shelf: 'B', coordinates: { x: 9, y: 11 } } },
  { id: '26', name: 'Notebook', category: 'Stationery', location: { section: 'stationery', aisle: 17, shelf: 'A', coordinates: { x: 13, y: 10 } } },
  { id: '27', name: 'Pen Pack', category: 'Stationery', location: { section: 'stationery', aisle: 17, shelf: 'B', coordinates: { x: 15, y: 11 } } },
];